...
// VERSION: 2025-06-21-003 - AUDIO STATE FIX
console.log('🎯 SIDEPANEL.JS LOADING - Version 2025-06-21-003 (Audio State Fix)');
console.log('🎯 Fixed: Audio status label and dot now update correctly');
